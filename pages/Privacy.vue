<template>
  <div class="m-5 p-4 text-left">
    ...
    <p>Spacesly ("us", "we", or "our") operates the https://Spacesly.com website (the "Service").</p>
    ...
    <h3>Use of Data</h3>
    <p>Spacesly uses the collected data for various purposes:</p>
    ...
    <p>Spacesly will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
    <h3>Disclosure Of Data</h3>
    <h4>Legal Requirements</h4>
    <p>Spacesly may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
    <p>To comply with a legal obligation</p>
    <p>To protect and defend the rights or property of Spacesly</p>
    ...
    <p>By visiting this page on our website: https://Spacesly.com/contact-us</p>
  </div>
</template>
